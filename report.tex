...
% Colors
\definecolor{primary}{RGB}{0,100,0}  % Dark Green
...
\begin{center}
    ...
    {\Large\textbf{Soumeye Ebi El Maaly}}\\[0.3cm]
    {\small Academic Year 2025--2026}\\[2cm]
    {\small\textcolor{gray}{\textit{Built with Apache Spark, Kafka, and MLlib}}}\\[0.5cm]
    {\small\textcolor{gray}{GitHub: \url{https://github.com/souma406/mini-project-spark-football.git}}}
\end{center}
\vfill
\newpage

% Skip Contents page - go directly to content
...
\vfill
\begin{center}
\textcolor{gray}{\small\textbf{GitHub Repository:} \url{https://github.com/souma406/mini-project-spark-football.git}}
\end{center}
